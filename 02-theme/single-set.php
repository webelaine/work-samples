	...
	(function($){
		...
		$(document).ready(function(){
			$(".childNav a").each(function() {           
				$(this).html($(this).html().replace(" - School of Science, Engineering and Technology",""));
				$(this).html($(this).html().replace(" of the School of Science, Engineering and Technology",""));
			});
